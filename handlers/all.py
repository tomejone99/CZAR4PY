...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/GRU4TH3CZAR")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/CONTACT4BOT")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/GRU4TH3CZAR")]])
